...
$voto1 = "INSERT INTO voto (IDVOTO, ntjeans, id_jure, id_part,qnd) VALUES (NULL, $n1,$idjure ,6 ,NOW() )";
$res = mysqli_query($con, $voto1);
$linhas = mysqli_affected_rows($con);
?>
...
$voto2 = "INSERT INTO voto (IDVOTO, ntjeans, id_jure, id_part,qnd) VALUES (NULL, $n2,$idjure ,7 ,NOW() )";
$res = mysqli_query($con, $voto2);
$linhas = mysqli_affected_rows($con);
?>
...
$voto3 = "INSERT INTO voto (IDVOTO, ntjeans, id_jure, id_part,qnd) VALUES (NULL, $n3,$idjure ,8,NOW() )";
$res = mysqli_query($con, $voto3);
$linhas = mysqli_affected_rows($con);
...
$voto4 = "INSERT INTO voto (IDVOTO, ntjeans, id_jure, id_part,qnd) VALUES (NULL, $n4,$idjure ,9,NOW() )";
$res = mysqli_query($con, $voto4);
$linhas = mysqli_affected_rows($con);
...
$voto5 = "INSERT INTO voto (IDVOTO, ntjeans, id_jure, id_part,qnd) VALUES (NULL, $n5,$idjure ,10,NOW() )";
$res = mysqli_query($con, $voto5);
$linhas = mysqli_affected_rows($con);
