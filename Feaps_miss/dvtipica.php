...
foreach ($notas as $key => $nota) {
    ...
    if (!verificaVoto($con, $idjure, $id_part)) {
        $insertQuery = "INSERT INTO voto (IDVOTO, nttipica, id_jure, id_part, qnd) VALUES (NULL, $nota, $idjure, $id_part, NOW())";
    } else {
        $updateQuery = "UPDATE voto SET nttipica = $nota, qnd = NOW() WHERE id_jure = $idjure AND id_part = $id_part";
